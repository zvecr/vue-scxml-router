...
export default class VueStateRouter {
  constructor(model, opts = {}) {
    if (!VueStateRouter.__installed) {
      throw new Error('not installed. Make sure to call `Vue.use(VueStateRouter)` before creating root instance.');
    }
  ...
  static install(Vue, opts = {}) {
    ...
    Object.defineProperty(Vue.prototype, '$router', {
      get() {
        return {
          ...
          canEmit: event => this.__routerRoot.__router.__state.nextEvents.includes(event),
        };
      },
    });
    ...
    Object.defineProperty(Vue.prototype, '$route', {
      get() {
        return {
          name: this.__routerRoot.__router.__state.value, // toStrings()[0];//this._service;
    ...
    VueStateRouter.__installed = true;
  }
}
